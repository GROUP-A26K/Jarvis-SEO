# Scripts SEO v7 — Groupe Genevoise
...
```
scripts/
  seo-shared.js              # Module central (63 exports, circuit breakers, retry, sanitize)
  seo-gap-analysis.js        # Script 1 : gap analysis Semrush
  seo-publish-article.js     # Script 2 : publication article (Claude + Sanity)
  seo-weekly-report.js       # Script 3 : rapport hebdomadaire (GSC + Semrush)
  seo-orchestrator.js        # Script 4 : orchestrateur workflow (plan/execute/approve/publish)
  seo-images.js              # Script 5 : pipeline images AI (Flux 2 via BFL EU)
  seo-exhibits.js            # Script 6 : pipeline exhibits (SVG → Gemini image-to-image)
  setup-check.js             # Verification secrets au demarrage
  README.md
sites/
...
secrets/
  ...
  google-gemini.json         # { "api_key": "..." } (pour exhibits)
data/
